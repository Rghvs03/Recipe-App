  ...
  return (
    <div className="max-w-sm w-full bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-[#ff4a4a] flex flex-col mx-4 my-3">
      ...
      <div className="p-4 flex flex-col flex-1 gap-2">
        ...
        <div className="max-h-16 overflow-y-auto text-gray-700 text-sm mb-4 px-2">
          {elem.ingredients}
        </div>
        ...
        <div className="mt-auto flex gap-2">
          <button className="flex-1 bg-[#ff4a4a] py-2 rounded-xl text-white font-semibold hover:bg-[#d13a3a] transition shadow">
            Explore Now
          </button>
